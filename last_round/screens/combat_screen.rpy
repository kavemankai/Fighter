...
image portrait_muay_thai = Solid("#60403a")
image portrait_capoeira  = Solid("#405060")
image portrait_wrestler  = Solid("#504030")

image sprite_karate_idle    = Solid("#4a8060")
image sprite_boxer_idle     = Solid("#904040")
image sprite_muay_thai_idle = Solid("#806050")
image sprite_capoeira_idle  = Solid("#507080")
image sprite_wrestler_idle  = Solid("#706050")
